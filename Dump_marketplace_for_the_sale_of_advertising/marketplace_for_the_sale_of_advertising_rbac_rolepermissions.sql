...
CREATE TABLE `rbac_rolepermissions` (
  ...
  CONSTRAINT `rbac_rolepermissions_ibfk_1` FOREIGN KEY (`RoleID`) REFERENCES `rbac_roles` (`RoleID`),
  CONSTRAINT `rbac_rolepermissions_ibfk_2` FOREIGN KEY (`PermissionID`) REFERENCES `rbac_permissions` (`PermissionID`)
